...
\* concurrency is in development but not fully implemented as of version 0.1.3. Track concurrency in [issue #123](https://github.com/JakeRoggenbuck/kronicler/issues/123).
